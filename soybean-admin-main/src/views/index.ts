...
> = {
  ...
  admin_login: () => import('./admin/login/index.vue'),
  admin_management_auth: () => import('./admin/management/auth/index.vue'),
  admin_management_role: () => import('./admin/management/role/index.vue'),
  admin_management_route: () => import('./admin/management/route/index.vue'),
  admin_management_user: () => import('./admin/management/user/index.vue'),
  app_home_company: () => import('./app/home/company/index.vue'),
  app_home_componets_hotcompany: () => import('./app/home/componets/hotcompany/index.vue'),
  app_home_componets_hotjob: () => import('./app/home/componets/hotjob/index.vue'),
  app_home_componets_jobmenuselect: () => import('./app/home/componets/jobmenuselect/index.vue'),
  app_home: () => import('./app/home/index.vue'),
  app_jobs: () => import('./app/jobs/index.vue'),
  app_login: () => import('./app/login/index.vue'),
